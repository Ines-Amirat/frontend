  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "sky-1": "linear-gradient(180deg, #E8F3FF 0%, #F6FBFF 100%)",
      },
      boxShadow: {
        form: "0px 1px 2px rgba(16,24,40,.05)",
        chart: "0px 1px 3px rgba(16,24,40,.10),0px 1px 2px rgba(16,24,40,.06)",
        profile: "0px 12px 16px -4px rgba(16,24,40,.08),0px 4px 6px -2px rgba(16,24,40,.03)",
        creditCard: "8px 10px 16px rgba(0,0,0,.05)",
      },
      keyframes: {
